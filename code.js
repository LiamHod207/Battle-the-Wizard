...
async function BeginAttack() {
    ...
    if (ATTACKER.state == "ready") {
        if (ATTACKER.move == "basic") {
            let player1Damage = getRandomInteger(1, 20);
    ...
    if (HEALER.state == "ready") {
        if (HEALER.move == "basic") {
            ...
            if (alivePlayers.length === 3) {
                ...
                queueText(HEALER.name + " uses Fresh Air, healing the whole team for 40hp");
                ...
                queueText(HEALER.name + " uses Fresh Air, healing the team for 20hp and reviving " + deadPlayer.name + " with 30hp");
            } else {
                ...
                queueText(HEALER.name + " uses Fresh Air, healing themselves for 40hp and reviving " + revivedPlayer.name + " with 40hp");
            }
